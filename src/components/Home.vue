<template id="main-page">
  <v-ons-page>
    ...
    <v-ons-card v-for="i in 10" :key="i">
      <ons-row>
        <ons-col width="40%">
          <img src="https://www.egaliteetreconciliation.fr/local/cache-vignettes/L300xH300/arton46203-22af1.jpg" alt="Onsen UI" style="width: 100%">
        </ons-col>
